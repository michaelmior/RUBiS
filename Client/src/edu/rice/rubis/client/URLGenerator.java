...
public abstract class URLGenerator
{
   ...
   */
  public URLGenerator(String host, int port, String HTMLFilesPath,
  ...
  /**
   * Set the web site name. For example:
   * 
   * <pre>
  ...
  /**
   * Set the location where the HTML files reside on the web site. For example:
   * 
   * <pre>
   * URLGenerator urlGen = new URLGenerator();
  ...
  /**
   * Set the location where the script files reside on the web site. For
   * example:
   * 
   * <pre>
   * URLGenerator urlGen = new URLGenerator();
  ...
  /**
   * Return the string representing a float number in a format understandable by
   * the database. This function needs to be fixed since it still does not work
   * with large number.
   * 
   * @param f the float value to convert
   * @return a string representing the float conforming to database
   *         representation.
   */
  protected String convertFloatToStringDatabaseFormat(float f)
  {
    ...
    if (E != -1)
      /*
       * We have something like 1.2345E6 but the database needs 1.2345E+6 So, we
       * need to add the +
       */
  ...
  public URL genericHTMLFile(String filename)
  {
    ...
    {
      System.out
          .println("Error while generating the URL corresponding to the file: "
              + e.getMessage());
      return null;
    }
  }
  ...
  public URL homePage()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, HTMLPath
          + "/index.html");
      return url;
    }
    catch (java.net.MalformedURLException e)
  ...
  public URL register()
  {
    ...
    {
      System.out.println("Error while generating register page URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * Register a new user in the database. You must provide all information that
   * are requested by the web page.
   * 
   ...
   * @param regionName region name where the user live (warning it is case
   *          sensitive)
      ...
      String email, String password, String regionName)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + RegisterUserScript() + "?firstname=" + firstname + "&lastname="
          + lastname + "&nickname=" + nickname + "&email=" + email
          + "&password=" + password + "&region=" + regionName);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating register user page URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  public URL browse()
  {
    ...
    {
      System.out.println("Error while generating browse page URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * Access the Browse Categories page of RUBiS that lists all available
   * categories. The user can then select a category to view all items in that
   * category.
   * 
  ...
  public URL browseCategories()
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + BrowseCategoriesScript());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating Browse Categories script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * Access the Browse Regions page of RUBiS that lists all available region.
   * The user can then select a region to view all categories available in that
   * region.
   * 
  ...
  public URL browseRegions()
  {
    ...
    {
      System.out.println("Error while generating Browse Regions script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'browse all items in a category' script. You must provide both
   ...
   */
  public URL browseItemsInCategory(int categoryId, String categoryName,
      int page, int nbOfItems)
  {
    try
    {
      categoryName = URLEncoder.encode(categoryName);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + SearchItemsByCategoryScript() + "?category=" + categoryId
          + "&categoryName=" + categoryName + "&page=" + page + "&nbOfItems="
          + nbOfItems);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'browse all items in a category' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'browse all categories in a region' script. You must provide the
   * region name.
   * 
  ...
  public URL browseCategoriesInRegion(String regionName)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + BrowseCategoriesScript() + "?region=" + regionName);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'browse all categories in a region' script URL: "
              + e.getMessage());
      return null;
    }
  }
   ...
   */
  public URL browseItemsInRegion(int categoryId, String categoryName,
      int regionId, int page, int nbOfItems)
  {
    try
    {
      categoryName = URLEncoder.encode(categoryName);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + SearchItemsByRegionScript() + "?region=" + regionId + "&category="
          + categoryId + "&categoryName=" + categoryName + "&page=" + page
          + "&nbOfItems=" + nbOfItems);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'browse all items in a category in a region' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  public URL viewItem(int itemId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + ViewItemScript() + "?itemId=" + itemId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'View Item' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  public URL viewBidHistory(int itemId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + ViewBidHistoryScript() + "?itemId=" + itemId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'View Bid History' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  public URL viewUserInformation(int userId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + ViewUserInfoScript() + "?userId=" + userId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'View User Information' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Comment on an user' script. You must provide the item id and
   * the user id of the receiver of this comment. This will lead to a user
   * authentification.
   * 
   * @param itemId item identifier
  ...
  public URL putCommentAuth(int itemId, int toId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + PutCommentAuthScript() + "?itemId=" + itemId + "&to=" + toId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'Comment on an user' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Put Comment on another user' script. This is the page the user
   * can access when it has been successfully authenticated.
   * 
   * @param itemId item identifier
   * @param toId receiver user identifier
  ...
  public URL putComment(int itemId, int toId, String name, String pwd)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + PutCommentScript() + "?itemId=" + itemId + "&to=" + toId
    ...
    {
      System.out
          .println("Error while generating 'Put Comment on another user' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'StoreComment' script. This action really stores a new comment
   * in the database.
   * 
   * @param itemId item identifier
   * @param toId receiver user identifier
   ...
   */
  public URL storeComment(int itemId, int toId, int fromId, int rating,
      String comment)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + StoreCommentScript() + "?itemId=" + itemId + "&to=" + toId
          + "&from=" + fromId + "&rating=" + rating + "&comment=" + comment);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating StoreComment script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Bid now on an Item' script. You must provide the item id. This
   * will lead to a user authentification.
   * 
   * @param itemId item identifier
  ...
  public URL putBidAuth(int itemId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + PutBidAuthScript() + "?itemId=" + itemId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'Bid now on an Item' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Put bid on an Item' script. This is the page the user can
   * access when it has been successfully authenticated. You must provide the
   * item id, user name and password.
   * 
   * @param itemId item identifier
   * @param name user's name
   * @param pwd user's password
  ...
  public URL putBid(int itemId, String name, String pwd)
  {
    try
    {
      ...
      pwd = URLEncoder.encode(pwd);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + PutBidScript() + "?itemId=" + itemId + "&nickname=" + name
          + "&password=" + pwd);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'Put bid on an Item' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Store bid' script. This action really stores a new bid in the
   * database.
   * 
   * @param itemId item identifier
   * @param userId user identifier
   ...
   */
  public URL storeBid(int itemId, int userId, float minBid, float bid,
      float maxBid, int qty, int maxQty)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + StoreBidScript() + "?itemId=" + itemId + "&userId=" + userId
          + "&minBid=" + convertFloatToStringDatabaseFormat(minBid)
          + "&maxQty=" + maxQty + "&bid="
          + convertFloatToStringDatabaseFormat(bid) + "&maxBid="
          + convertFloatToStringDatabaseFormat(maxBid) + "&qty=" + qty);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Store bid' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Buy now an Item' script. You must provide the item id. This
   * will lead to a user authentification.
   * 
   * @param itemId item identifier
  ...
  public URL buyNowAuth(int itemId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + BuyNowAuthScript() + "?itemId=" + itemId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Buy now auth' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'buy now' script. This action displays the item information and
   * ask the user to confirm he want to buy it.
   * 
   * @param itemId item identifier
   * @param name user's name
   * @param pwd user's password
  ...
  public URL buyNow(int itemId, String name, String pwd)
  {
    try
    {
      ...
      pwd = URLEncoder.encode(pwd);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + BuyNowScript() + "?itemId=" + itemId + "&nickname=" + name
          + "&password=" + pwd);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Buy Now' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'store buy now' script. This action really buys an item and
   * update the database (if authentication is successfull).
   * 
   * @param itemId item identifier
  ...
  public URL storeBuyNow(int itemId, int userId, int qty, int maxQty)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + StoreBuyNowScript() + "?itemId=" + itemId + "&userId=" + userId
          + "&qty=" + qty + "&maxQty=" + maxQty);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Store Buy Now' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  public URL sell()
  {
    ...
    {
      System.out.println("Error while generating sell page URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Select category to sell item' script. This is the page the user
   * can access when it has been successfully authenticated. You must provide
  ...
  public URL selectCategoryToSellItem(String name, String pwd)
  {
    try
    {
      ...
      pwd = URLEncoder.encode(pwd);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + BrowseCategoriesScript() + "?nickname=" + name + "&password=" + pwd);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out
          .println("Error while generating 'Select category to sell item' script URL: "
              + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Sell item form' script. This is the page the user accesses ones
   * it has choosen a category. You must provide the user id and the category
   * id.
   * 
  ...
  public URL sellItemForm(int categoryId, int userId)
  {
    ...
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + SellItemFormScript() + "?user=" + userId + "&category="
          + categoryId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Sell item form' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'Register item' script. This action really stores a new item in
   * the database.
   * 
   ...
   * @param duration duration of the auction in days (usually no more than 7
   *          days)
  ...
  public URL registerItem(String name, String description, float initialPrice,
      float reservePrice, float buyNow, int duration, int quantity, int userId,
      int categoryId)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + RegisterItemScript() + "?name=" + name + "&description="
          + description + "&initialPrice="
          + convertFloatToStringDatabaseFormat(initialPrice) + "&reservePrice="
          + convertFloatToStringDatabaseFormat(reservePrice) + "&buyNow="
          + convertFloatToStringDatabaseFormat(buyNow) + "&duration="
          + duration + "&quantity=" + quantity + "&userId=" + userId
          + "&categoryId=" + categoryId);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'Register item' script URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the "About Me" page of the web site. This leads to a user
   * authentication.
   * 
  ...
  public URL aboutMe()
  {
    ...
    {
      System.out.println("Error while generating about_me page URL: "
          + e.getMessage());
      return null;
    }
  }
  ...
  /**
   * URL to the 'About Me' script. This is the page the user can access when it
   * has been successfully authenticated. You must provide the user's name and
   * password.
   * 
   * @param name user's name
   * @param pwd user's password
  ...
  public URL aboutMe(String name, String pwd)
  {
    try
    {
      ...
      pwd = URLEncoder.encode(pwd);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath + "/"
          + AboutMeScript() + "?nickname=" + name + "&password=" + pwd);
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
      System.out.println("Error while generating 'About Me' script URL: "
          + e.getMessage());
      return null;
    }
  }
